...
public class BO_DupilcateRefference extends Wrapper_methods{
	@Test
	public void BO_DupilcateRefference () throws IOException{
		...
		//enter the documenet reference id
				...
				enterTextById("DocumentReference32", "CAB 120/22");
			    ...
			    String actual = getTextByXpath("//div[@class='validation-summary-errors']/ul/li");
				  ...
				  System.out.println("BO_DupilcateRefference -     "+actual);
				   
				  Assert.assertTrue(actual.contains("CAB 120/22 - Remove duplicate catalogue reference."));
