...
public class BO_Orderable_Max40_ValidGmail extends Wrapper_methods{
	@Test
	public void BO_Orderable_Max40_ValidGmail () throws IOException{
		...
		//enter the documenet reference id
			  ...
			  System.out.println("BO_Orderable_Max40_ValidGmail-"+text);
