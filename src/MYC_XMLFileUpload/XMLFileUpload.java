...
public class XMLFileUpload extends Wrapper_methods{
	@Test
public void XMLFileUpload() throws IOException, InterruptedException{
		...
		Thread.sleep(3000);
		Runtime.getRuntime().exec("C:\\Users\\hparupalli\\AutoIt_MYC\\ALLLevels.exe");
		Thread.sleep(3000);
		...
		Assert.assertTrue(Actual.contains("ALLLevels.xml - Upload completed"));
