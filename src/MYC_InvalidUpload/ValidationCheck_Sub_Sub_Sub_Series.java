...
public class ValidationCheck_Sub_Sub_Sub_Series extends Wrapper_methods{
	...
	public void Sub_Sub_Sub_Series() throws IOException, InterruptedException{
		...
		Thread.sleep(3000);
		Runtime.getRuntime().exec("C:\\Users\\hparupalli\\AutoIt_MYC\\Sub_Sub_Sub_Series.exe");
		Thread.sleep(3000);
		...
		System.out.println("Sub_Sub_Sub_Series "+Actual_Error);
		Assert.assertTrue(Actual_Error.contains("Error We require a valid level hierarchy in this field. It is not possible to have sub-sub-sub-series directly under series 4"));
