...
public class ValidationCheck_FondsWithNoLegalStatus extends Wrapper_methods{
	...
	public void FondsWithNoLegalStatus() throws IOException, InterruptedException{
		...
		Thread.sleep(3000);
		Runtime.getRuntime().exec("C:\\Users\\hparupalli\\AutoIt_MYC\\FondsWithNoLegalStatus.exe");
		Thread.sleep(3000);
		...
		System.out.println("FondsWithNoLegalStatus "+Actual_Error);
		Assert.assertTrue(Actual_Error.contains("Error 'Legal status' is a required field at fonds level for this collection. 2"));
		quitBrowser();
