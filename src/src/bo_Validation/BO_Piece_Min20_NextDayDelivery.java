...
public class BO_Piece_Min20_NextDayDelivery extends Wrapper_methods{
	@Test
	public void BO_Piece_Min20_NextDayDelivery () throws IOException{
		...
		//enter the documenet reference id
			    ...
			    String actual = getTextByXpath("//div[@class='validation-summary-errors']/ul/li");
				   ...
				   Assert.assertEquals("Select a date that is at least three working days from now.", actual);
