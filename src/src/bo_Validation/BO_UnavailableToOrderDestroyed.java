...
public class BO_UnavailableToOrderDestroyed extends Wrapper_methods{
	@Test
	public void BO_UnavailableToOrderDestroyed() throws IOException{
	...
	GetBulkOrderURL();
	    ...
	    clickbyXpath("//input[@value='Continue']");
		   ...
		   System.out.println("BO_UnavailableToOrderDestroyed -  "+actual);
