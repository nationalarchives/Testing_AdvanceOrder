...
public class OD_ClosedRecord extends Wrapper_methods{
	@Test
	public void OD_ClosedRecord() throws IOException{
		...
		enterTextById("DocumentReference1", "HO 405/38199");
	    ...
	    clickbyXpath("//input[@value='Continue']");
		   ...
		   System.out.println("OD_ClosedRecord.java"+actual);
		   
		   Assert.assertEquals("HO 405/38199 - This document is closed and cannot be ordered. Check the catalogue for more information.", actual);
