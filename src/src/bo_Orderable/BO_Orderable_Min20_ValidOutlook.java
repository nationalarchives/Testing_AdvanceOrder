...
public class BO_Orderable_Min20_ValidOutlook extends Wrapper_methods{
	@Test
	public void BO_Orderable_Min20_ValidOutlook () throws IOException{
		...
		//enter the documenet reference id
			  ...
			  System.out.println("BO_Orderable_Min20_ValidOutlook - "+text);
