...
public class OD_availableToOrderLivesSafeRoom extends Wrapper_methods{
	@Test
	public void OD_UnavailableToOrderLivesSafeRoom() throws IOException{
		...
		enterTextById("DocumentReference1", "WO 95/1234");
 ...
 //click complete order
	    ...
	    System.out.println("OD_availableToOrderLivesSafeRoom"+actual);
