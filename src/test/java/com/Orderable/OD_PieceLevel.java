...
public class OD_PieceLevel extends Wrapper_methods{
	@Test
	public void OD_PieceLevel() throws IOException, InterruptedException{
		...
		enterTextById("DocumentReference1", "PRO30/69/1753/1");
		enterTextById("DocumentReference2", "PRO30/69/1753/2");
	   ...
	   // String actual1 =getTextByXpath("//div[@class='entry-content clearfix']/p[2]");
	    ...
	    System.out.println("OD_PieceLevel.java   "+actual);
