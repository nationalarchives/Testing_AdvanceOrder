...
public class OD_CollectionCare extends Wrapper_methods{
	@Test
	public void OD_CollectionCare() throws IOException{
		...
		enterTextById("DocumentReference1", "ADM 33/97");
	    ...
	    clickbyXpath("//input[@value='Continue']");
		   ...
		   System.out.println("OD_CollectionCare.java"+actual);
		   
		   Assert.assertEquals("ADM 33/97 - This document cannot be ordered. Check the catalogue for more information.", actual);
