...
public class OD_Oderable_RN_8912657_DEFE2555 extends Wrapper_methods{
	@Test
 ...
 String actualDocument =getTextByXpath("//ol[@class='two-tier-list']/li");
	    ...
	    Assert.assertTrue(actualDocument.contains("DEFE 25/555: Operation Corporate (Falkland Conflict): Board of Inquiry into the loss of HMS Sheffield; report"));
