...
public class OD_Oderable_RN_7940369_J90546 extends Wrapper_methods{
	@Test
	...
	//quitBrowser();   
	  ...
	  Assert.assertEquals(actual1,"Order documents in advance");
		*/
	    ...
	    Assert.assertTrue(actualDocument.contains("J 90/546: Details of this piece are shown at items level"));
